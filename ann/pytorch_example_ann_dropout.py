...
#pytorch with dropout
#only diff compared to keras is that pytorch has model.train() and model.eval() 
...
model.add_module('dropout1', torch.nn.Dropout(0.2))
model.add_module('dense1', torch.nn.Linear(D, 300))
model.add_module('relu1', torch.nn.ReLU())
model.add_module('dropout2', torch.nn.Dropout(0.5))
model.add_module('dense2', torch.nn.Linear(300, 100))
model.add_module('relu2', torch.nn.ReLU())
model.add_module('dropout3', torch.nn.Dropout(0.5))
